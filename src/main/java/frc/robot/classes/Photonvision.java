...
public class Photonvision {
    ...
    private static final double cameraZ = Units.inchesToMeters(6.75); //Height from ground
    private static final double cameraRY = Units.degreesToRadians(61.4); //Mounting bracket angle
