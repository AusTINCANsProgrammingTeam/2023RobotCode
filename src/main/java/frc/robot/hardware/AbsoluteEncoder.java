...
public class AbsoluteEncoder {
    public enum EncoderConfig {
        ...
        //Arm Encoders (REV)
        /*
        ArmBase(1, true, Units.degreesToRadians(-75.3)),
        ArmChooChoo(2),
        ArmElbow(0, true, Units.degreesToRadians(217.33));
        */
        ArmBase(1, true, Units.degreesToRadians(0)),
        ArmChooChoo(2),
        ArmElbow(0, true, Units.degreesToRadians(0));
