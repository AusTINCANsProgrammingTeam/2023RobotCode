 ...
 * 
 * @file CubeapultSubsystem.java
 *
 * @brief The main class for controlling the cube launcher
 *
 *
 * @section Changelog
...
public class CubeapultSubsystem extends SubsystemBase {
  private static final int solenoidForwardID = 1; 
  private static final int solenoidReverseID = 0; 
